...
struct lista *buscar(struct lista *list, int val) {
	...
	}while(w < verificador+1);


	if(encontrado == 1 && verificador ==1){
		int *imprime;
		
		imprime= &voltar->valor;
		printf("Valor encontrado!\n");
		printf("\nValor anterior:%i   |   ",*imprime);
